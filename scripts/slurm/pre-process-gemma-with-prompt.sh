...
#SBATCH --output /bask/projects/v/vjgo8416-co-beagle/slurm_logs/pre-process-gemma-msmarco-clustering_prompt.out
...
python3 scripts/preprocess_from_config.py --json_config_path configs/GemmaEmbed_config_clustering_prompt.json