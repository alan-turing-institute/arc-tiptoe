...
#SBATCH --qos turing
#SBATCH --job-name process-distilbert-msmarco-test
#SBATCH --time 5:0:0
#SBATCH --nodes 1
#SBATCH --gpus 1
#SBATCH --cpus-per-gpu 36
#SBATCH --output /bask/projects/v/vjgo8416-co-beagle/slurm_logs/pre-process-distilbert-msmarco-test.out
...
python3 scripts/preprocess_from_config.py --json_config_path configs/distilbert_config_post_embeddings_test.json